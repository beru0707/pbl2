...
template <> constexpr inline auto LoginWidget::qt_create_metaobjectdata<qt_meta_tag_ZN11LoginWidgetE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(std::shared_ptr<NguoiDung>)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
        // Slot 'onDangNhap'
...
void LoginWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->dangNhapThanhCong((*reinterpret_cast<std::add_pointer_t<std::shared_ptr<NguoiDung>>>(_a[1]))); break;
        case 1: _t->onDangNhap(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (LoginWidget::*)(std::shared_ptr<NguoiDung> )>(_a, &LoginWidget::dangNhapThanhCong, 0))
            return;
    }
}
...
// SIGNAL 0
void LoginWidget::dangNhapThanhCong(std::shared_ptr<NguoiDung> _t1)
{
